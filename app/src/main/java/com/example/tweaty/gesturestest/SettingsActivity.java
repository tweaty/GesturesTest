...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        fakeHeader.setTitle(R.string.pref_header_test_resolution);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_test_resolution);

        // Add 'notifications' preferences, and a corresponding header.
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_test_parameters);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_test_parameters);

        // Add 'data and sync' preferences, and a corresponding header.
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_save_file);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_save_file);
...
//        bindPreferenceSummaryToValue(findPreference("example_text"));
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        // current value.
        if (preference instanceof ResolutionPickerPreference || preference instanceof NumberPickerPreference)
        {
            // Trigger the listener immediately with the preference's
            // current value.
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class TestResolutionPreferenceFragment extends PreferenceFragment {
        @Override
...
//            bindPreferenceSummaryToValue(findPreference("example_list"));
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class TestParametersPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_test_parameters);
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class SaveFilePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_save_file);
